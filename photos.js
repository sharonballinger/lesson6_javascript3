...
function previewFive() {
    ...
    //disable the 'Show more images' button after it had been selected once
...
function createEventListeners() { 
    ...
    var rightarrow = document.getElementById("rightarrow");
        ...
        //add an event handler to the specifed document element (rightarrow)
    ...
    //when the user clicks the Show More button the previewFive function is excuted
